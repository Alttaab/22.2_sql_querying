...
SELECT app_name, rating, price FROM analytics WHERE price BETWEEN .10 AND 1 ORDER BY reviews DESC LIMIT 10;
...
SELECT app_name, reviews, min_installs / reviews as proportion 
    FROM analytics
